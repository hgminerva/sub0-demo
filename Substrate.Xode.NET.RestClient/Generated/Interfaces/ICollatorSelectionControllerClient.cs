...
namespace Substrate.Xode.NET.RestClient.Generated.Interfaces
{
   ...
   public interface ICollatorSelectionControllerClient
   {
      ...
      Task<U32> GetLastAuthoredBlock(Substrate.Xode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
      Task<bool> SubscribeLastAuthoredBlock(Substrate.Xode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
