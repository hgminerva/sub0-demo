...
namespace Substrate.Xode.NET.RestClient.Test.Generated
{
   ...
   public class CollatorSelectionControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Xode.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6 GetTestValue2()
      {
         Substrate.Xode.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6 result;
         result = new Substrate.Xode.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6();
         result.Value = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Xode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>();
         result.Value.Create(new Substrate.Xode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32[] {
                  this.GetTestValue3()});
         return result;
      }
      ...
      public async System.Threading.Tasks.Task TestInvulnerables()
      {
         ...
         Substrate.Xode.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6 mockupValue = this.GetTestValue2();
         ...
         Substrate.Xode.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6 rpcResult = await rpcClient.GetInvulnerables();

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public Substrate.Xode.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7 GetTestValue5()
      {
         Substrate.Xode.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7 result;
         result = new Substrate.Xode.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7();
         result.Value = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Xode.NET.NetApiExt.Generated.Model.pallet_collator_selection.pallet.CandidateInfo>();
         result.Value.Create(new Substrate.Xode.NET.NetApiExt.Generated.Model.pallet_collator_selection.pallet.CandidateInfo[] {
                  this.GetTestValue6()});
         return result;
      }
      public Substrate.Xode.NET.NetApiExt.Generated.Model.pallet_collator_selection.pallet.CandidateInfo GetTestValue6()
      {
         Substrate.Xode.NET.NetApiExt.Generated.Model.pallet_collator_selection.pallet.CandidateInfo result;
         result = new Substrate.Xode.NET.NetApiExt.Generated.Model.pallet_collator_selection.pallet.CandidateInfo();
         result.Who = new Substrate.Xode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
         result.Who = this.GetTestValue7();
         result.Deposit = this.GetTestValueU128();
         return result;
      }
      public Substrate.Xode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetTestValue7()
      {
         Substrate.Xode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 result;
         result = new Substrate.Xode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
         result.Value = new Substrate.Xode.NET.NetApiExt.Generated.Types.Base.Arr32U8();
      ...
      public async System.Threading.Tasks.Task TestCandidates()
      {
         ...
         // Construct new RPC client to test with.
         CollatorSelectionControllerClient rpcClient = new CollatorSelectionControllerClient(_httpClient, subscriptionClient);
         Substrate.Xode.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7 mockupValue = this.GetTestValue5();
         ...
         Substrate.Xode.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7 rpcResult = await rpcClient.GetCandidates();
      ...
      public async System.Threading.Tasks.Task TestLastAuthoredBlock()
      {
         ...
         Substrate.Xode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 mockupKey = this.GetTestValue9();
